...
- `src/components/FittingSessionForm.tsx`: ROSE K2 XL worksheet (Print optimized).
- `src/components/RGPFittingSessionForm.tsx`: RGP worksheet (Print optimized).
- `src/components/FollowUpSessionForm.tsx`: Follow-up worksheet (Print optimized).
...
- `src/components/SingleFittingProcedureForm.tsx`: RGP trial lens form (Compact grid).
- `src/components/SingleRoseK2XLFittingProcedureForm.tsx`: ROSE K2 XL trial lens form (Compact grid).
